            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-gray-400 text-sm flex items-start gap-2">
                  ...
                  <span className="text-gray-300 text-sm">79 Kennedy Avenue Amritsar Punjab 143001</span>
                </p>
              </div>
              <div>
                <p className="text-gray-400 text-sm flex items-start gap-2">
                  ...
                  <span className="text-gray-300 text-sm">2 Maple Street Back side IVY Hospital Airport Road Amritsar Punjab 143001</span>
                </p>
              </div>
            </div>
          </div>
